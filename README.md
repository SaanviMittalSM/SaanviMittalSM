...
I build data-driven and machine learning projects spanning engineering, environmental economics, and healthcare — from predicting structural sensor readings to classifying medical data to analyzing global trade.

## 🔧 What I work with

- **Languages & Tools:** Python, C, Jupyter, pandas, NumPy
- **Machine Learning:** scikit-learn (classification, regression, model tuning)
- **Data Visualization:** matplotlib, seaborn, geopandas
- **Backend & Systems:** FastAPI, PostgreSQL, Docker, compiler/parser design
...
- **[Virtual Water Project](https://github.com/SaanviMittalSM/virtual-water-project)** — analysis of India's virtual water trade embedded in cereal crop exports and imports.
